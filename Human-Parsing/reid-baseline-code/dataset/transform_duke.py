...
from utils import *
from dataset_utils import partition_train_val_set
from dataset_utils import new_im_name_tmpl
from dataset_utils import parse_im_name as parse_new_im_name
from dataset_utils import move_ims
from dataset_utils import get_im_names
...
if __name__ == '__main__':
  ...
  parser.add_argument('--zip_file', type=str,
                      default='~/PCB_RPP/datasets/data1/data1.zip')
  parser.add_argument('--save_dir', type=str,
                      default='~/PCB_RPP/datasets/data1/tridata1')
